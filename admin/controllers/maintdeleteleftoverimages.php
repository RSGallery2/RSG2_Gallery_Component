 ...
 * @since 4.3.0
 */
class Rsgallery2ControllerMaintDeleteLeftOverImages extends JControllerAdmin
{
	...
	function DeleteFromFolderList()
	{
		...
		$this->setRedirect('index.php?option=com_rsgallery2&view=maintDeleteLeftOverImages', $msg, $msgType);
	}
