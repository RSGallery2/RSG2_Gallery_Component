...
class rsgalleryVersion {
    ...
    var $RELEASE    = '4.0.10';				//Main Release Level: x.y for x.y.z
    ...
    var $COPYRIGHT  = '&copy; 2005 - 2016 <strong><a class="rsg2-footer" href="http://www.rsgallery2.nl">RSGallery2</a></strong>. All rights reserved.';
    /** @var string URL */
