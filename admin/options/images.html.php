									...
									<td>
										<div align="center">
											...
											switch ($item->type)
											{
												...
												{
													?>
													<object type="application/x-shockwave-flash" width="400" height="15" data="<?php echo JURI_SITE ?>/components/com_rsgallery2/flash/xspf/xspf_player_slim.swf?song_title=<?php echo $row->name ?>&song_url=<?php echo audioUtils::getAudio($row->name) ?>">
														<param name="movie" value="<?php echo JURI_SITE ?>/components/com_rsgallery2/flash/xspf/xspf_player_slim.swf?song_title=<?php echo $item->title; ?>&song_url=<?php echo $original->url(); ?>" />
													</object>
													<?php
													break;
												}
								...
								<table class="adminform">
									...
									<tr>
										...
										<td width="80%">
											...
											<?php echo JText::_('COM_RSGALLERY2_FILE') ?>&nbsp;<input type="file" size="48" id="images" name="images[]" class="required" /><br />
											<hr />
					...
					foreach ($ziplist as $filename)
					{
						...
						<td align="center" valign="top" bgcolor="#CCCCCC">
							<table class="adminform" border="0" cellspacing="1" cellpadding="1">
								...
								<tr>
									<td colspan="2" align="left"><?php echo JText::_('COM_RSGALLERY2_DELETE'); ?> #<?php echo $i - 1; ?>:
