...
<div id="installer-install" class="clearfix">
	...
	<div id="j-main-container" class="span10">
		...
		<div id="j-main-container">
			...
			<form action="<?php echo JRoute::_('index.php?option=com_rsgallery2&view=config&amp;layout=RawEditOld'); ?>"
					method="post" name="adminForm" id="adminForm" class="form-validate form-horizontal">

                <legend><?php echo JText::_('COM_RSGALLERY2_CONFIG_MINUS_RAW_EDIT'); ?> Old</legend>
                <div><strong><?php echo JText::_('COM_RSGALLERY2_CONFIG_MINUS_RAW_EDIT_TXT'); ?> Old</strong><br></div>
