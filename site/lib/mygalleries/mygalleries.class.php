		...
		<div class="current">
			<table class="adminlist">
				...
				<tr>
					...
					<td><?php echo $maxcat; ?>&nbsp;(<font color="#008000"><strong><?php echo galleryUtils::userCategoryTotal($user->id); ?></strong></font> <?php echo JText::_('COM_RSGALLERY2_NR_OF_USERGALLERIES_CREATED'); ?>)
					</td>
				</tr>
				<tr>
					<td><?php echo JText::_('COM_RSGALLERY2_MAXIMUM_IMAGES_ALLOWED'); ?></td>
					<td><?php echo $max_images; ?>&nbsp;(<font color="#008000"><strong><?php echo galleryUtils::userImageTotal($user->id); ?></strong></font> <?php echo JText::_('COM_RSGALLERY2_NR_OF_IMAGES_UPLOADED'); ?>)
					</td>
				</tr>
			</table>
		</div>
	...
	static function showMyGalleries($rows)
	{
		...
		<div class="rsg2">
			<table class="adminlist">
				...
				<tr>
					<th>
						<div align="left"><?php echo JText::_('COM_RSGALLERY2_GALLERY'); ?></div>
					</th>
					<th width="75">
						<div align="center"><?php echo JText::_('COM_RSGALLERY2_PUBLISHED'); ?></div>
					</th>
					<th width="75">
						<div align="center"><?php echo JText::_('COM_RSGALLERY2_DELETE'); ?></div>
					</th>
					<th width="75">
						<div align="center"><?php echo JText::_('COM_RSGALLERY2_EDIT'); ?></div>
					</th>
				</tr>
				<?php
				if ($count == 0)
				{ //No galleries
					?>
					<tr>
						<td colspan="4"><?php echo JText::_('COM_RSGALLERY2_NO_USER_GALLERIES_CREATED'); ?></td>
					</tr>
				<?php
				} else
				{ //List of galleries
					...
					<tr>
						...
						<td>
							...
							else
							{
								...
								if ($row->published == 1)
								{
									$img = "published-inactive.png";
								}
								else
								{
									$img = "unpublished-inactive.png";
								}
								?>
								<div align="center">
									<img src="<?php echo JURI_SITE; ?>components/com_rsgallery2/images/<?php echo $img; ?>" alt="<?php echo JText::_('JACTION_EDITSTATE'); ?>" width="19" position="top">
	...
	static function showMyImages($images, $pageNav)
	{
		...
		<form name="showMyImages" id="adminForm" method="post"
			...
			<table class="adminlist">
				...
				?>
					<tr>
						<td colspan="5"><?php echo JText::_('COM_RSGALLERY2_NO_IMAGES_IN_USER_GALLERIES'); ?></td>
					</tr>
					<?php
				}
				?>
		...
		<form name="editItem" id="adminForm" method="post"
			...
			<table class="adminlist">
				...
				<tr>
					...
					<td rowspan="3">
						<img src="<?php
						//echo imgUtils::getImgThumbPath($filename); 
