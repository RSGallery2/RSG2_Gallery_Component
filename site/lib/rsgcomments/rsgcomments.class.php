...
class rsgComments
{
		...
		<form name="rsgcommentform" method="post" action="<?php echo JRoute::_("index.php?option=com_rsgallery2&rsgOption=rsgComments&task=save"); ?>">
			<table border="0" width="100%" class="adminForm">
				...
				<tr>
					...
					<td>
						<input name='tname' type='text' class='inputbox' size='40' value='<?php if (!$my->username == '')
						{
							echo $my->username;
						} ?>' />
					</td>
					...
					<tr>
						...
						<td class="title">
							<div class="addcomment">
								<a class="special" href="#comment2"><?php echo JText::_('COM_RSGALLERY2_ADD_COMMENT'); ?></a>
							</div>
						</td>
					</tr>
				</table>
					...
					<table width="100%" class="comment_table">
						<tr>
							<td colspan="2" class="title">
								<span class='posttitle'><?php echo $comment['subject']; ?></span></td>
						</tr>
						<tr>
							<td valign="top" width="100">
								<span class="postusername"><?php echo $comment['user_name']; ?></span></td>
							</td>
							<td valign="top" class="content_area">
								...
								<?php if ($deleteComment): ?>
									<div style="float:right;">
										<a href="javascript:void(0);" onclick="delComment(<?php echo $comment['id']; ?>, <?php echo $comment['item_id']; ?>, <?php echo $catid; ?>);"><?php echo JText::_('COM_RSGALLERY2_DELETE_COMMENT') ?></a>
									</div>
								<?php endif; ?>
							</td>
						</tr>
		...
		else
		{
			...
			<div id="comment">
				<table width="100%" class="comment_table">
					<tr>
						<td class="title">
							<span class='posttitle'><?php echo JText::_('COM_RSGALLERY2_NO_COMMENTS_YET') ?></span></td>
					</tr>
				</table>
			</div>
			<?php
	...
	function _get($id)
	{
		...
		if (!is_numeric($id))
		{
			die("item id is not a number: $id");
		}
